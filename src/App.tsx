  ...
  return (
    <div className="flex flex-col h-screen w-full bg-slate-50 text-slate-900 overflow-hidden font-sans">
      <nav className="h-14 bg-blue-900 text-white flex items-center justify-between px-6 shrink-0 shadow-md">
        <div className="flex items-center space-x-4"><div className="w-8 h-8 bg-blue-500 rounded flex items-center justify-center font-bold">RF</div><h1 className="text-lg font-semibold tracking-tight">PakLink | <span className="font-normal text-blue-200">Offline Map Manager v2.0</span></h1></div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 relative bg-slate-200 p-4 overflow-hidden flex flex-col">
          {activeTab === 'map' && <div className="relative flex-1 min-h-0"><MapViewer /><OfflineMapControls /></div>}
